 ...
 * @author jenni
 */
public class frm_DetalleSalida extends javax.swing.JInternalFrame {

    /**
     * Creates new form frm_usuario
     */
    public frm_DetalleSalida() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("idDetlleSalida");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(TxtidDetalleSalida, javax.swing.GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)
        ...
        LogDetalleSalida funcdetallesalida =new LogDetalleSalida();
           DatosDetalleSalida dtsdetallesalida=new  DatosDetalleSalida();
    ...
    private void btnaccionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaccionActionPerformed
        try {
           dtsdetallesalida.setIdDetalle_Salida(Integer.parseInt(TxtidDetalleSalida.getText()+""));
           dtsdetallesalida.setClave(TxtClave.getText());
           dtsdetallesalida.setCantidad(Integer.parseInt(TxtCantidad.getText()+""));
           dtsdetallesalida.setIdsalida(Integer.parseInt(TxtidSalida.getText()+""));
         ...
         String accion=lblaccion.getText(); 
            ...
            if(accion.equals("guardar")){
               if (funcdetallesalida.insertar(dtsdetallesalida)) {
           ...
           if (accion.equals("editar")) {
               ...
               if (funcdetallesalida.editar(dtsdetallesalida)) {
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        try {  dtsdetallesalida.setIdDetalle_Salida(Integer.parseInt(TxtidDetalleSalida.getText()));
         if (funcdetallesalida.eliminar(dtsdetallesalida)) {
                    JOptionPane.showMessageDialog(rootPane, "El detalle salida fue Eliminado satisfactoriamente");
                 this.dispose();
    ...
    public static javax.swing.JTextField TxtidDetalleSalida;
